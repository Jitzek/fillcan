...
namespace fillcan {
    ...
    bool CommandBuffer::begin(VkCommandBufferUsageFlags flags = 0, VkCommandBufferInheritanceInfo* pSecondaryCommandBufferInheritanceInfo = nullptr) {
    ...
    bool CommandBuffer::reset(VkCommandBufferResetFlags flags = 0) {
