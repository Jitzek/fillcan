...
<Highlight language={cppHighlight} code={`VkExtent3D getExtent();`} />
<MethodDescription>
    <span slot="details"> Get the extent of the Image. </span>
    <span slot="return"> The extent of the Image. </span>
</MethodDescription>
