...
<Highlight language={cppHighlight} code={`VkFormat getFormat();`} />
<MethodDescription>
    <span slot="details"> Get the format of the Image. </span>
    <span slot="return"> The format of the Image. </span>
</MethodDescription>
