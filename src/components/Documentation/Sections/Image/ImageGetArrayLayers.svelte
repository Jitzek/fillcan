...
<Highlight language={cppHighlight} code={`unsigned int getArrayLayers();`} />
<MethodDescription>
    <span slot="details">Get the amount of array layers of the Image.</span>
    <span slot="return">The amount of array layers of the Image.</span>
</MethodDescription>
