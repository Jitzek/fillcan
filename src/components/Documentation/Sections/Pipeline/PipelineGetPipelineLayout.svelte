...
<Highlight
    ...
    code={`PipelineLayout* getPipelineLayout();`}
/>
<MethodDescription>
    <span slot="details">
        Get the the <Reference sectionID={SectionID.PIPELINE_LAYOUT}
            >pipeline layout</Reference
        >.
    </span>
    <span slot="return">
        A pointer to the <Reference sectionID={SectionID.PIPELINE_LAYOUT}
            >pipeline layout</Reference
        >.
    </span>
</MethodDescription>
