...
<Highlight
    ...
    code={`const VkShaderModule getShaderModuleHandle() const;`}
/>
<MethodDescription>
    <span slot="details">
        Get the handle to the <Anchor
            href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkShaderModule.html"
            target="_blank">Vulkan Shader Module</Anchor
        >.
    </span>
    <span slot="return">
