...
<Highlight language={cppHighlight} code={`unsigned int getQueuendex();`} />
<MethodDescription>
    <span slot="details">
        Get the index of this Queue within the queue family.
    </span>
    <span slot="return">The index of this Queue within the queue family.</span>
</MethodDescription>
