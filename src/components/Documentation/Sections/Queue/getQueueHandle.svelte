...
<Highlight
    ...
    code={`const VkQueue getQueueHandle(); const`}
/>
<MethodDescription>
    <span slot="details">
        Get the handle to the <Anchor
            href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkQueue.html"
            target="_blank">Vulkan Queue</Anchor
        >.
    </span>
    <span slot="return">
