...
<Highlight
    ...
    code={`void createSurface(Instance* pInstance);`}
/>
<MethodDescription>
    <span slot="details">
        Create a <Anchor
            href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkSurfaceKHR.html"
            target="_blank">Vulkan Surface</Anchor
        > using the <Anchor
