...
<Highlight language={cppHighlight} code={`void resolveCurrentAttachments();`} />
<MethodDescription>
    <span slot="details">
        Mark the current batch of color attachments as resolved, these are
        attachments to which multisample image data is converted.
    </span>
</MethodDescription>
