...
<Highlight
    ...
    code={`void setDepthStencilAttachment(unsigned int attachmentDescriptionIndex, VkImageLayout layout, bool preserve);`}
/>
<MethodDescription>
    <span slot="details">
        Define the depth and stencil buffer for this subpass.
    </span>
    <div slot="params">
        <li>
