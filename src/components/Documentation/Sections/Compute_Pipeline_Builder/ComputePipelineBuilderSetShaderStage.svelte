...
<Highlight
    ...
    code={`void setShaderStage(PipelineShaderStage pipelineShaderStage);`}
/>
<MethodDescription>
    <span slot="details">
        Set the <Reference sectionID={SectionID.PIPELINE_PIPELINE_SHADER_STAGE}
            >pipeline shader stage</Reference
        > for the <Reference sectionID={SectionID.COMPUTE_PIPELINE}
            >compute pipeline</Reference
        >.
    </span>
    <div slot="params">
        <li>
            <code>pipelineShaderStage</code><br />
            The <Reference sectionID={SectionID.PIPELINE_PIPELINE_SHADER_STAGE}
                >pipeline shader stage</Reference
            >.
        </li>
    </div>
