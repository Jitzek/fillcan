...
<Highlight
    ...
    code={`const VkRenderPass getRenderPassHandle() const;`}
/>
<MethodDescription>
    <span slot="details">
        Get the handle to the <Anchor
            href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkRenderPass.html"
            target="_blank">Vulkan Render Pass</Anchor
        >.
    </span>
    <span slot="return">
