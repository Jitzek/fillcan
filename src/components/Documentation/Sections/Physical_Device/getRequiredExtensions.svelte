...
<Highlight
    ...
    code={`const std::vector<const char*>& getRequiredExtensions() const;`}
/>
<MethodDescription>
    <span slot="details">
        Get the device extensions (given in the <Reference
            sectionID={SectionID.PHYSICAL_DEVICE_Constructor}
            >Constructor</Reference
        >) this Physical Device should support.
    </span>
    <span slot="return">A list of the required device extensions.</span>
</MethodDescription>
