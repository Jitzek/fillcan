...
<Highlight language={cppHighlight} code={`bool areExtensionsSupported();`} />
<MethodDescription>
    <span slot="details">
        Whether the device extensions given in the <Reference
            sectionID={SectionID.PHYSICAL_DEVICE_Constructor}
            >Constructor</Reference
        > are supported.
    </span>
    <span slot="return"
        ><code>true</code> if the device extensions are supported.
        <code>false</code> if the device extensions aren't supported.</span
    >
</MethodDescription>
