...
<Highlight
    ...
    code={`const VkPhysicalDeviceProperties getProperties() const;`}
/>
<MethodDescription>
    <span slot="details">Query all properties of this Physical Device.</span>
    <span slot="return"
        >A <Anchor
            href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceProperties.html"
            target="_blank">VkPhysicalDeviceProperties</Anchor
        >-structure specifying the properties of this Physical Device.</span
    >
</MethodDescription>
