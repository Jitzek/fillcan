...
<Highlight
    ...
    code={`std::unique_ptr<Sampler> getResult();`}
/>
<MethodDescription>
    <span slot="details">
        Get the resulting <Reference sectionID={SectionID.SAMPLER}
            >Sampler</Reference
        >.
    </span>
    <span slot="return">
        ...
        > to the <Reference sectionID={SectionID.SAMPLER}>Sampler</Reference>,
