...
namespace simple_camera {
    ...
    void App::run() {
        ...
        this->upVertexShaderModule =
            this->upFillcan->createShaderModule(this->APP_DIR + "/shaders", "simple.vert", shaderc_vertex_shader,
                                                std::move(upVertexDescriptorSetLayouts), std::move(upVertexDescriptorPool), true, false);
    ...
    std::vector<std::unique_ptr<fillcan::DescriptorSetLayout>> App::createVertexDescriptorSetLayouts() {
        std::vector<std::unique_ptr<fillcan::DescriptorSetLayout>> upDescriptorSetLayouts = this->upCamera->getDescriptorSetLayouts(0);
